...
class SubgraphImp : public Subgraph {
 ...
 public:
  ...
  std::set<Op*> get_input_ops() override;
  const std::set<const Op*> get_input_ops() const override;

  std::set<Op*> get_output_ops() override;
  const std::set<const Op*> get_output_ops() const override;
