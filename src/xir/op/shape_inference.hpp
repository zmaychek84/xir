...
void shape_infer_equal(xir::Op* cur);
void shape_infer_greater(xir::Op* cur);
void shape_infer_greater_equal(xir::Op* cur);
void shape_infer_less(xir::Op* cur);
void shape_infer_less_equal(xir::Op* cur);
void shape_infer_or(xir::Op* cur);
void shape_infer_and(xir::Op* cur);
...
void shape_infer_reciprocal(xir::Op* cur);
...
void shape_infer_layernorm(xir::Op* cur);
...
void shape_infer_clamp(xir::Op* cur);
void shape_infer_round(xir::Op* cur);
void shape_infer_sqrt(xir::Op* cur);
void shape_infer_not(xir::Op* cur);
void shape_infer_abs(xir::Op* cur);
void shape_infer_channel_shuffle(xir::Op* cur);
void shape_infer_pow(xir::Op* cur);
void shape_infer_where(xir::Op* cur);
...
void shape_infer_mac_fix(xir::Op* cur);

// shape_infer function for qdq ops
void shape_infer_qlinear_conv2d(xir::Op* cur);
void shape_infer_qlinear_transposed_conv2d(xir::Op* cur);
void shape_infer_qlinear_depthwise_conv2d(xir::Op* cur);
void shape_infer_qlinear_pool(xir::Op* cur);
void shape_infer_qlinear_eltwise(xir::Op* cur);
void shape_infer_qlinear_reduction_mean(xir::Op* cur);
void shape_infer_qlinear_reduction_sum(xir::Op* cur);
void shape_infer_qlinear_reduction_max(xir::Op* cur);
void shape_infer_qlinear_reduction_min(xir::Op* cur);
void shape_infer_qlinear_matmul(xir::Op* cur);
